...
/**
 * 类ProcessServiceImpl.java的实现描述：TODO 类实现描述
 * 
 * @author wanglei 2018年4月30日 下午6:42:39
 */
@Service
public class ProcessServiceImpl implements ProcessService {
    ...
    public Model convertToModel(String procDefId) throws Exception {
        ...
        modelData.setVersion(Integer.parseInt(String.valueOf(repositoryService.createModelQuery().modelKey(modelData.getKey()).count()
                                                             + 1)));
